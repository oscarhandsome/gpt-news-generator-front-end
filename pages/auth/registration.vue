...
<template>
  ...
  <div class="relative lg:my-5 w-full max-w-lg sm:mx-auto mt-0 sm:shadow-2xl">
    ...
    <div
      class="bg-white sm:border sm:border-gray-200 sm:rounded-lg sm:shadow dark:bg-gray-800 dark:sm:border-gray-700 sm:drop-shadow-2xl p-4 sm:p-6 md:p-8 mx-auto"
    >
      <!-- <div
